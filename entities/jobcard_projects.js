...
var jobcardprojectSchema=new mongoose.Schema({
	...
	baterias:[{tipo:String,serie:String, voltagem:String, amperagem:String}],
	transformador:[{marca:String, capacidade:String, tensao:String, corrente:String, funcionalidade:String}],
	retificador:[{marca:String, modelo:String, modulos:String, serie:[String]}]
})

jobcardprojectSchema.statics.gravarDados=function(jobcardproject, callback){
	this.create(jobcardproject, callback);
}

jobcardprojectSchema.statics.visualizacao=function(jobcardproject, callback){
	this.find(jobcardproject);
	}

module.exports=mongoose.model("JobCard_Project",jobcardprojectSchema, "JobCard_Project");